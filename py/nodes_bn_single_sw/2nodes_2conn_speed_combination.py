...
def test_2nodes_2connections():
    """
    Test DUT to ATE direct with two connection and validate. 
    """
    ...
    d1_port2.id = "intf2"
    d1_port2.speed = d1_port2.S_100GB
    ...
    d2_port2.id = "intf2"
    d2_port2.speed = d2_port2.S_100GB
    ...
    link2.dst.device = d2.id
    link2.dst.port = d2_port2.id  
